...
public class Board {
	...
	/**
	 * Setter for Computer Board Takes start and end tiles for ships and places the ships
	...
	/**
	 * Setter for Human Board Takes start and end tiles for ships and places the ships
	 * Populates the area around the ships as empty sea
	 * @param t1 start Tile
	 * @param t2 end Tile
	 */
	 ...
	 * This method is called when an update of board needs to be presented.
	 */
	...
	*/
	...
	/*
	 * public static void main(String args[]) { Board b=new Board(); Tile t1= new
	 * Tile(2,3); Tile t2=new Tile(4,3); Tile t3= new Tile(7,4); Tile t4=new
	 * Tile(4,4); /* b.setBoard(t1, t2, "Human"); b.setBoard(t3, t4, "Human");
	 * b.printBoard(); }
	 */
